    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_method', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='site_settings.PaymentMethod')),
            ],
            options={
                'ordering': ['is_paid', '-date_expired'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('occupation', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='transcations.Occupation', verbose_name='Απασχόληση')),
        ...
        migrations.AddField(
            model_name='bill',
            name='category',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='bills', to='transcations.BillCategory'),
        ),
        migrations.AddField(
            model_name='bill',
            name='payment_method',
