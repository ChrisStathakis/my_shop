...
urlpatterns = [
    ...
    path('order/<int:pk>/order-payment-manager/', order_payment_manager_edit_or_remove,
         name='order_payment_edit_or_remove'),
    ...
    path('vendor-detail/convert-order/<int:dk>/<int:pk>/', view=warehouse_check_order_convert,
         name='order_convert'),
    ...
    path('payment/detail/edit-payment/<int:dk>/<int:pk>/', view=warehouse_edit_paid_order,
         name='ware_order_paid_edit'),
    path('payment/detail/delete-payment/<int:pk>/', view=warehouse_order_paid_delete,
