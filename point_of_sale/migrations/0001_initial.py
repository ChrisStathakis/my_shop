    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_expired', models.DateField(default=datetime.datetime(2018, 10, 4, 12, 22, 25, 290057, tzinfo=utc))),
                ...
                ('order_type', models.CharField(choices=[('r', 'Retail Order'), ('e', 'Eshop'), ('b', 'Return Order'), ('wa', 'Παραστατικό Εισαγωγής'), ('wr', 'Export Invoice')], default='r', max_length=1)),
