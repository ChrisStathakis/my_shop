    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('brand', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='my_site.Brands', verbose_name='Brand Name')),
                ...
                ('category_site', models.ManyToManyField(blank=True, null=True, to='my_site.CategorySite')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='product',
            name='color',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='products.Color', verbose_name='Χρώμα'),
        ),
        migrations.AddField(
            model_name='product',
